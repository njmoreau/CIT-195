...
namespace TB_QuestGame
{
    ...
    public static class ConsoleLayout
    {
        ...
        //
        public static int MenuBoxWidth = 35;
        public static int MenuBoxHeight = 29;
        ...
        //
        public static int MessageBoxWidth = 122;
        public static int MessageBoxHeight = 25;
        public static int MessageBoxPositionLeft = 37;
        public static int MessageBoxPositionTop = 3;

        //
        // input box configuration
        //
        public static int InputBoxWidth = 122;
        public static int InputBoxHeight = 4;
        public static int InputBoxPositionLeft = 37;
        public static int InputBoxPositionTop = 28;

        //
        // status box configuration
        //
        public static int StatusBoxWidth = 35;
        public static int StatusBoxHeight = 10;
        public static int StatusBoxPositionLeft = 1;
        public static int StatusBoxPositionTop = 22;
    }
}
